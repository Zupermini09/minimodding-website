    ...
    <div className="mx-auto max-w-3xl px-6 sm:px-8">
      <header className="relative py-16 sm:py-24">
        ...
        <div className="relative">
          ...
          <h1 className="text-display mt-4 text-5xl font-bold tracking-tight sm:text-6xl">
            {about.title}
          </h1>
      ...
      <div className="flex flex-col gap-6 pb-12">
        {about.sections.map((section, i) => (
          <section
            key={section.heading}
            className="rounded-3xl border-[1.5px] border-line bg-surface p-8 shadow-card sm:p-10"
          >
