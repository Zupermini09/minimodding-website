...
// Hero children rise in sequence on load; each gets its own delay.
    ...
    <div className="mx-auto max-w-6xl px-6 sm:px-8">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative py-28 sm:py-40">
          <p className="label anim-rise text-accent" style={rise(0)}>
            BeamNG.drive — Minimodding
          </p>
          ...
          <h1
            ...
            style={rise(0.1)}
          >
            <span className="text-shimmer">Precision-built</span> mod packs for
            BeamNG.drive.
          </h1>
      ...
      {/* Workshop credo ticker — full-bleed across the viewport */}
      ...
      {/* Spec strip */}
      <Reveal>
        <section className="mt-24 grid grid-cols-1 gap-[1.5px] overflow-hidden rounded-3xl border-[1.5px] border-line bg-line shadow-card sm:grid-cols-3">
          {[
            ...
            <div
              key={title}
              className="group bg-surface px-8 py-10 transition-colors hover:bg-surface-2/60"
            >
              <Icon
                size={20}
                strokeWidth={1.75}
          ...
          <section className="mt-24">
            ...
            <Spotlight>
              <Link
                ...
                className="spotlight-card group grid grid-cols-1 overflow-hidden rounded-3xl border-[1.5px] border-line bg-surface shadow-card transition-all duration-300 hover:border-line-strong hover:shadow-card-hover lg:grid-cols-2"
              >
